...
RE::TESObjectREFR* targetForm2 = nullptr;
RE::TESObjectREFR* selectedForm = nullptr;
...
void FillQuestWithGeneratedData(RE::TESQuest* inQuest, RE::TESObjectREFR* inTarget)
{
	...
	//=============================
	{
		...
		SQG::AddAliasPackage(inQuest, inTarget, customAcquirePackage, "PF_SQGAcquirePackage");
	}
	...
	//=============================
	{
		...
		SQG::AddAliasPackage(inQuest, inTarget, customActivatePackage, "PF_SQGActivatePackage");
	}
	...
	//=============================
	{
		...
		SQG::AddAliasPackage(inQuest, inTarget, customTravelPackage, "PF_SQGTravelPackage");
	}
...
std::string GenerateQuest(RE::StaticFunctionTag*)
{
	...
	FillQuestWithGeneratedData(generatedQuest, selectedForm);
	...
	if(const auto messaging = SKSE::GetMessagingInterface(); !messaging 
		|| !messaging->RegisterListener([](SKSE::MessagingInterface::Message* message)
		{
			if (auto* dataHandler = RE::TESDataHandler::GetSingleton(); message->type == SKSE::MessagingInterface::kDataLoaded)
			{
				...
				selectedForm = targetForm = reinterpret_cast<RE::TESObjectREFR*>(dataHandler->LookupForm(RE::FormID{0x00439A}, "SQGLib.esp"));
				targetForm2 = reinterpret_cast<RE::TESObjectREFR*>(dataHandler->LookupForm(RE::FormID{0x00F018}, "SQGLib.esp"));
